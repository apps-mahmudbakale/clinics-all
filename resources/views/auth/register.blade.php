...
<body class="">
    ...
    <div class="vs-menu-wrapper">
        <div class="vs-menu-area text-center"><button class="vs-menu-toggle"><i class="fal fa-times"></i></button>
            <div class="mobile-logo"><a href="index.html"><img src="assets/img/logo-mobile.svg" alt="Medixi"></a>
            </div>
    ...
    <div class="breadcumb-wrapper">
        ...
        <div class="container z-index-common">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Create Account</h1>
        ...
        <div class="container">
            <div class="row gx-40">
                <div class="col-xl-12 mb-40 mb-xl-0 wow fadeInUp" data-wow-delay="0.3s">
                    <form action="{{ route('create-account') }}" class="form-wrap1 shadow-none mb-0" data-bg-color="#f3f6f7" method="POST">
                        @csrf
                        <div class="form-title-box bg-title" data-bg-src="assets/img/bg/bg-shape-9.jpg">
                            <div class="row justify-content-between align-items-center">
                                <div class="col">
                                    <h2 class="h4 mb-2 text-white">Create Account</h2>
                                    <p class="mb-0 text-white-light">Fill in all Fields</p>
                                </div>
                                <div class="col-auto d-none d-sm-block"><a 
                                        class="ripple-icon style2"><i class="fas fa-edit"></i></a></div>
                            </div>
                        </div>
                        <div class="form-box">
                            <div class="row">
                                ...
                                <div class="col-lg-6 form-group"><select class="form-select" name="gender">
                                        <option hidden disabled="disabled" selected="selected">Choose Gender</option>
                                        <option>Male</option>
                                        <option>Female</option>
                                    </select></div>
                                <div class="col-lg-6 form-group"><input type="text" name="date_of_birth" class="dateTime-pick form-control"
                                        placeholder="Date of Birth"></div>
                                <div class="col-lg-6 form-group"><input type="email" name="email" class="form-control"
                                ...
                                <div class="col-xl-12 text-center"><button type="submit" class="vs-btn style2">Create Account<i class="far fa-edit"></i></button></div>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto text-center text-md-end">
                        <p class="mb-0 text-white">Copyright <i class="fal fa-copyright"></i> 2023 <a
                                class="text-white" href="index.html">Medixi</a>. All rights reserved.</p>
                    </div>
