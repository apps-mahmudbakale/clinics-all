  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="{{ route('app.dashboard') }}" class="brand-link">
          <img src="{{ !empty(app(App\Settings\SystemSettings::class)->logo) ? asset('storage/settings/store/' . app(App\Settings\SystemSettings::class)->logo) : asset('assets/img/logo.png') }}"
              alt="logo" class="brand-image img-circle elevation-3" style="opacity: .8">
          <span
              class="brand-text font-weight-light">{{ app(App\Settings\SystemSettings::class)->clinic_name ?: 'Clinic' }}</span>
      </a>
